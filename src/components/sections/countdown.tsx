...
const CountdownSection = ({ onRegister }: CountdownSectionProps) => {
    return (
        <section className="min-h-screen relative flex items-center justify-center py-20 px-6 overflow-hidden">
            ...
            >
                <div className="mb-8">
                    ...
                    <p className="text-xl md:text-2xl font-light text-[#00e5ff] tracking-[0.3em] uppercase mb-6">
                        14 March 2026
                    </p>
                    <QuoteRotator />
                </div>
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-[radial-gradient(circle,rgba(255,0,255,0.05)_0%,transparent_70%)] pointer-events-none" />
        </section>
    );
}
