                        ...
                        <GlassCard className="p-8 md:p-12 h-full border-white/10 hover:border-sky-400/30 transition-all duration-500 bg-black/60 backdrop-blur-xl flex flex-col justify-center">
                            <div className="mb-6">
                                ...
                                <h2 className="text-4xl md:text-5xl font-black text-white tracking-tighter uppercase mb-6 leading-none">
                                    IN MEMORY OF <br />
                                    <span className="chrome-text-center-radiant text-6xl md:text-7xl">ABHIJIT MENON</span>
                                </h2>
                            </div>
                            <div className="text-white/90 text-lg md:text-xl leading-relaxed font-light text-left">
                                <p>
