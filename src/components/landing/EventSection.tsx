            ...
            >
                ...
                >
                    <ChromeButton
                        onClick={onRegister}
                        glowColor="purple"
                        className="scale-100 md:scale-[1.5] px-12 py-6 md:px-8 md:py-4 hover:shadow-[0_0_60px_rgba(181,51,255,0.4)]"
                    >
                        REGISTER NOW
                    </ChromeButton>
                    ...
                    >
                        ...
                        <div className="flex items-center gap-4 border-b border-white/10 pb-2 group-hover:border-neon-blue/50 transition-all">
                            ...
                            <svg className="w-6 h-6 text-white/60 group-hover:text-neon-blue group-hover:rotate-12 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor">
