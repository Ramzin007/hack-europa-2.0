...
function FallingLetter({ char, progress, index }: { char: string, progress: MotionValue<number>, index: number }) {
    ...
    return (
        <motion.span
            ...
            className="text-6xl md:text-9xl font-black chrome-text-custom leading-none tracking-tighter"
        >
            {char}
        </motion.span>
    );
    ...
    return (
        ...
        >
            <div className="sticky top-0 h-screen flex items-center justify-center overflow-hidden">
                ...
                >
                    <span className="text-sm md:text-lg uppercase tracking-[0.4em] text-white/80 mb-8 font-medium">
                        SAIT Presents
                    </span>
                ...
                {/* Ambient Floor Glow handled by ParallaxBackground */}
            </div>
        </section>
    );
}
